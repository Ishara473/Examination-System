...
<li class="breadcrumb-item">Results Import (Bulk)</li>
@endsection
...
<div class="card mb-1">
    <div class="card-body">
        ...
        <diV class="alert bg-gray-200 mt-3">
           ...
           <div id="instructions" class="collapse">
                ...
                <div class="row">            
                    <div class="col-md-12">
                        <p class="mb-0">
                            Upload a <strong>Excel</strong> file with the fotmat similar to the gpa file.  delete the last gpa fields before uploading
                        </p>
                    </div>
                </div>
            </div>
        ...
        {{ Form::open(['url'=>url('/admin/results/upload-results-bulk'),'method'=>'post','enctype'=>'multipart/form-data','id'=>'frmUpload']) }} 
        <div class="row">
        ...
        <div class="d-none" id="processUploadSection">
            {{ Form::open(['url'=>url('/admin/results/process-upload-bulk-results'),'method'=>'post','enctype'=>'multipart/form-data','id'=>'frmProcess']) }}
